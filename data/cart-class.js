...
class Cart {
  ...
  saveToStorage() {
    this.localStorage.setItem("cart-oop", JSON.stringify(this.cartItem));
  }
  ...
  updatePaymentSummary() {
    ...
    const itemCount = this.cartItem.reduce(
  ...
  loadFromStorage() {
    this.cartItem = JSON.parse(this.localStorage.getItem("cart-oop"));
    ...
    if (!this.cartItem) {
      this.cartItem = [
        ...
        {
          productId: "15b6fc6f-327a-4ec4-896f-486349e 85a3d",
          quantity: 1,
          deliveryOptionId: "2",
        },
      ];
